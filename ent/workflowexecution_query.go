...
func (_q *WorkflowExecutionQuery) QueryWorkflow() *WorkflowQuery {
...
func (_q *WorkflowExecutionQuery) QueryWorkflowVersion() *WorkflowVersionQuery {
...
func (_q *WorkflowExecutionQuery) QueryStepExecutions() *StepExecutionQuery {
...
func (_q *WorkflowExecutionQuery) QueryNotifications() *NotificationQuery {
...
func (_q *WorkflowExecutionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *WorkflowExecutionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *WorkflowExecutionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *WorkflowExecutionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *WorkflowExecutionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *WorkflowExecutionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *WorkflowExecutionQuery) WithWorkflow(opts ...func(*WorkflowQuery)) *WorkflowExecutionQuery {
	query := (&WorkflowClient{config: _q.config}).Query()
...
func (_q *WorkflowExecutionQuery) WithWorkflowVersion(opts ...func(*WorkflowVersionQuery)) *WorkflowExecutionQuery {
	query := (&WorkflowVersionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *WorkflowExecutionQuery) WithStepExecutions(opts ...func(*StepExecutionQuery)) *WorkflowExecutionQuery {
	query := (&StepExecutionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *WorkflowExecutionQuery) WithNotifications(opts ...func(*NotificationQuery)) *WorkflowExecutionQuery {
	query := (&NotificationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(workflowexecution.FieldDateCreated).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.WorkflowExecution.Query().
//		Select(workflowexecution.FieldDateCreated).
//		Scan(ctx, &v)
...
func (_q *WorkflowExecutionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*WorkflowExecution, error) {
	...
	if query := _q.withWorkflowVersion; query != nil {
		if err := _q.loadWorkflowVersion(ctx, query, nodes, nil,
			func(n *WorkflowExecution, e *WorkflowVersion) { n.Edges.WorkflowVersion = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withStepExecutions; query != nil {
		if err := _q.loadStepExecutions(ctx, query, nodes,
			func(n *WorkflowExecution) { n.Edges.StepExecutions = []*StepExecution{} },
			func(n *WorkflowExecution, e *StepExecution) {
	...
	if query := _q.withNotifications; query != nil {
		if err := _q.loadNotifications(ctx, query, nodes,
			func(n *WorkflowExecution) { n.Edges.Notifications = []*Notification{} },
			func(n *WorkflowExecution, e *Notification) { n.Edges.Notifications = append(n.Edges.Notifications, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *WorkflowExecutionQuery) loadWorkflow(ctx context.Context, query *WorkflowQuery, nodes []*WorkflowExecution, init func(*WorkflowExecution), assign func(*WorkflowExecution, *Workflow)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*WorkflowExecution)
	for i := range nodes {
...
func (_q *WorkflowExecutionQuery) loadWorkflowVersion(ctx context.Context, query *WorkflowVersionQuery, nodes []*WorkflowExecution, init func(*WorkflowExecution), assign func(*WorkflowExecution, *WorkflowVersion)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*WorkflowExecution)
	for i := range nodes {
...
func (_q *WorkflowExecutionQuery) loadStepExecutions(ctx context.Context, query *StepExecutionQuery, nodes []*WorkflowExecution, init func(*WorkflowExecution), assign func(*WorkflowExecution, *StepExecution)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(stepexecution.FieldWorkflowExecutionID)
	}
	query.Where(predicate.StepExecution(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(workflowexecution.StepExecutionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *WorkflowExecutionQuery) loadNotifications(ctx context.Context, query *NotificationQuery, nodes []*WorkflowExecution, init func(*WorkflowExecution), assign func(*WorkflowExecution, *Notification)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*WorkflowExecution)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(notification.FieldWorkflowExecutionID)
	}
	query.Where(predicate.Notification(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(workflowexecution.NotificationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *WorkflowExecutionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(workflowexecution.Table, workflowexecution.Columns, sqlgraph.NewFieldSpec(workflowexecution.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withWorkflowVersion != nil {
			_spec.Node.AddColumnOnce(workflowexecution.FieldWorkflowVersionID)
		}
	}
